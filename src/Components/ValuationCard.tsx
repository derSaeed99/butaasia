        ...
        <Card key={index} sx={{ minWidth: 200, ml: 1, mb: 1 }}>
          <CardContent>
            ...
            <Box sx={{ mb: 1 }}>
              ...
              <Rating
                value={rating.cookingExperience || 0}
                readOnly
                precision={0.5}
              />
            </Box>
            <Box sx={{ mb: 1 }}>
              ...
              <Typography variant="body1">{rating.receipeChoice}</Typography>
            </Box>
            <Box sx={{ mb: 1 }}>
              <Typography
                sx={{ fontSize: 14 }}
            ...
            <Box sx={{ mb: 1 }}>
              ...
              <Typography variant="body1">{rating.message}</Typography>
            </Box>
          </CardContent>
        </Card>
      ))}
